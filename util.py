...
def parse_input():
    ...
    args.infected_locations = check_locations(args.infected_locations, args.world_size)
...
def check_locations(locations, world_size):
    if locations == None:
        return [0,0] # Default starting location
    ...
    for coordinate in locations:
        if coordinate not in range(0, world_size):
            ...
            raise argparse.ArgumentTypeError(msg)
    # If everything passes, return locations
    return locations
